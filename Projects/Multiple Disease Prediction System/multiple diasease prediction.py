# -*- coding: utf-8 -*-
"""
Created on Mon Dec 16 16:29:31 2024
...
diabetes_model = pickle.load(open("C:/Users/vedika patil/Desktop/CODING/AI ML/AI ML LEARNING/Projects/Multiple Disease Prediction System/diabetes_model.sav", 'rb'))
heart_disease_model = pickle.load(open("C:/Users/vedika patil/Desktop/CODING/AI ML/AI ML LEARNING/Projects/Multiple Disease Prediction System/heart_disease_model.sav", 'rb'))
parkinson_model = pickle.load(open("C:/Users/vedika patil/Desktop/CODING/AI ML/AI ML LEARNING/Projects/Multiple Disease Prediction System/parkinsons_model.sav", 'rb'))
    ...
    if st.button("Parkinson's Test Result"):
        try:
            user_input = [float(fo), float(fhi), float(flo), float(Jitter_percent), float(Jitter_Abs),
                          float(RAP), float(PPQ), float(DDP), float(Shimmer), float(Shimmer_dB), float(APQ3),
                          float(APQ5), float(APQ), float(DDA), float(NHR), float(HNR), float(RPDE), float(DFA),
